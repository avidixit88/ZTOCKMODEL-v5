...
refresh_seconds = st.sidebar.slider("Refresh every (seconds)", 10, 180, 20, 5, key="ui_refresh_seconds") if auto_refresh else None
...
with tab_scan:
    ...
    if auto_refresh:
        ...
        time.sleep(float(refresh_seconds or 20))
        st.rerun()